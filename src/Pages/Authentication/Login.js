...
const Login = () => {
    ...
    useEffect(() => {
        if (googleUser || emailUser) {
            toast(`Welcome ${googleUser?.email || emailUser?._tokenResponse?.email}`);
            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <p className='text-center text-red-500 mb-4'>{emailError ? emailError?.message.slice(10) : ''}</p>
                        ...
                        <p className='mt-3 text-center'><small>New to Doctors Portal? <Link className='text-secondary' to='/register'>Create An Account</Link></small></p>
                    </form>
