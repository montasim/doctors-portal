            ...
            <div className='m-auto card w-96 bg-base-100 shadow-xl'>
                <div className='card-body'>
                    ...
                    <div>
                        ...
                        <p className='mt-4'><small>New to Doctors Portal? <Link className='text-primary' to="/signup">Create New Account</Link></small></p>

                        <p className='mt-2'><small>Forgot Password? <Link className='text-primary' to="/reset-password">Reset Password</Link></small></p>
